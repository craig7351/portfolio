          ...
          duration: 0.6
            ...
            <div className="text-center md:text-left">
              <h1 className="text-4xl md:text-5xl font-bold mb-4">
                <span className="bg-gradient-to-r from-primary via-chart-2 to-primary bg-clip-text text-transparent">Book-Ai</span>
              </h1>
              <p className="text-xl text-muted-foreground mb-6">AI 藝術家 / 創意工作者 / Vibecoding 愛好者</p>
              ...
              <div className="flex gap-4 mt-6 justify-center md:justify-start">
                <a href="https://www.facebook.com/profile.php?id=61584339789020" className="p-3 rounded-full bg-card border border-border hover:border-primary/50 transition-colors">
                  <Facebook className="w-5 h-5" />
                </a>
                <a href="https://github.com/craig7351" className="p-3 rounded-full bg-card border border-border hover:border-primary/50 transition-colors">
                  <Github className="w-5 h-5" />
                </a>
                <a href="mailto:craig7351@gmail.com" className="p-3 rounded-full bg-card border border-border hover:border-primary/50 transition-colors">
          ...
          duration: 0.6
            ...
            <div className="prose prose-invert max-w-none">
              <p className="text-muted-foreground leading-relaxed text-lg">
                你好！我是一位熱衷於探索 AI 技術與藝術創作交匯點的創作者。自從接觸 AI 以來，
                我便深深著迷於這項技術能夠將想像力具象化的魔力。
              </p>
              <p className="text-muted-foreground leading-relaxed text-lg mt-4">
                我的使命是透過分享教學內容，幫助更多人掌握 AI 創作工具，並激發他們的創意潛能。 無論是圖片/影片處理用的
                Gemini Nano Banana, Grok, ComfyUI，或是文件處理的Notebooklm，VibeCoding用的Cursor, Antigravity, Google
                ai studio, Lovable，我都樂於探索並分享各種技巧與心得。
              </p>
            </div>
          </motion.div>
        </div>
